...
Технические навыки: Python (Pandas, Matplotlib, Seaborn, Plotly), Excel, SQL: PostgreSQL (оператор JOIN, подзапросы, временные таблицы, оконные функции , агрегирующие функции), 1C, Tableau, DataLens.  
