...
Изучил инструментарий для анализа данных и статистики, владею навыками работы в Python, Excel, SQL, Tableau. В зоне ближайшего развития: углубиться в Data science и разработку.
